...
class TD3_Process_Module(multiprocessing.Process):
    '''
    TD3 네트워크
        - 구조
            [======
    ...
    def run(self):
        from TD3.TD3_Network import TD3
        ...
        # 네트워크 클래스 호출해옴
        Network_model = TD3(self.action_dim, self.state_dim, self.time_dim, self.net_type, self.nub_agent,
                            self.all_mem)
