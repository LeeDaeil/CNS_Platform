...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self._area_graph = QtWidgets.QFrame(self._main_frame)
        self._area_graph.setFrameShape(QtWidgets.QFrame.Box)
        self._area_graph.setFrameShadow(QtWidgets.QFrame.Raised)
        self._area_graph.setLineWidth(2)
        self._area_graph.setObjectName("_area_graph")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self._area_graph)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setSpacing(0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self._area_graph_para = QtWidgets.QFrame(self._area_graph)
        self._area_graph_para.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self._area_graph_para.setFrameShadow(QtWidgets.QFrame.Raised)
        self._area_graph_para.setObjectName("_area_graph_para")
        self.horizontalLayout.addWidget(self._area_graph_para)
        self._area_graph_thre = QtWidgets.QFrame(self._area_graph)
        self._area_graph_thre.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self._area_graph_thre.setFrameShadow(QtWidgets.QFrame.Raised)
        self._area_graph_thre.setObjectName("_area_graph_thre")
        self.horizontalLayout.addWidget(self._area_graph_thre)
        self.verticalLayout.addWidget(self._area_graph)
