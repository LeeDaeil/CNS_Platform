...
class ab_make_flowchart(QWidget):
    def __init__(self, mem, parent=None):                                    #
        super(ab_make_flowchart, self).__init__(parent)                    #
...
class nor_make_flowchart(QWidget):
    def __init__(self, mem, parent=None):
        super(nor_make_flowchart, self).__init__(parent)
        print(mem)
        # self.parent = parent
        # self.setGeometry(self.parent.geometry())
        # self.trig_mem = mem
...
if __name__ == '__main__':
    ...
    win_main = ab_make_flowchart()
    # win_main = nor_make_flowchart()
    win_main.show()
    sys.exit(app.exec_())